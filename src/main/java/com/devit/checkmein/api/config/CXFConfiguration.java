package com.devit.checkmein.api.config;
...
public class CXFConfiguration {
	...
	@Autowired
	private CheckMeInApi checkMeInApi;

	@Autowired
	private WhoAreThereApi whoAreThereApi;
	...
	private void setServiceBeans(JAXRSServerFactoryBean endpoint) {
		endpoint.setServiceBean(checkMeInApi);
		endpoint.setServiceBean(whoAreThereApi);
	}
